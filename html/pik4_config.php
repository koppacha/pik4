...
$php_update  = '2021/09/18';					// 最終更新日
$sys_ver     = '2.76';						// バージョン表記 (2015年11月01日より簡易化：MNN形式で3桁にする)
...
$limited_num = 17 ;						// 現在の期間限定ランキング通しNo. (0＝非開催)
$uplan_num   = 0 ;						// 現在の参加者企画通しNo.（0＝非開催）
$limited_stage = array();					// 現在の期間限定ランキング対象ステージ (非開催時は最後の開催ステージの最終IDのみ残す）
$limited_start_time = strtotime( '2021-10-22 22:00:00');	// 期間限定ランキング開始時間
$limited_end_time   = strtotime( '2021-10-29 21:59:59');	// 期間限定ランキング終了時間 (→pik4.jsにも反映する)
