...
$limited_num = 18 ;						// 現在の期間限定ランキング通しNo. (0＝非開催)
$uplan_num   = 0 ;						// 現在の参加者企画通しNo.（0＝非開催）
$limited_stage = array();					// 現在の期間限定ランキング対象ステージ (非開催時は最後の開催ステージの最終IDのみ残す）
$limited_start_time = strtotime( '2022-10-08 20:00:00');// 期間限定ランキング開始時間
$limited_end_time   = strtotime( '2022-10-10 19:59:59');// 期間限定ランキング終了時間 (→pik4.jsにも反映する)
