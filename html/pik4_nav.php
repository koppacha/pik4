...
//		$color = ($stage_id == 171231 or $stage_id == 180429) ? '#df73af' : '#777' ;
		$background_color = 'background-color:#333;';
		$color = 'color:#fff;';
		if($stage_id == 171231 or $stage_id == 180429) $background_color = 'background-color:#b6db5c;';
		if($stage_id == 171231 or $stage_id == 180429) $color = '#111;';
		...
		$background_color = 'background-color:#333;';
		$color = 'color:#fff;';
		if($stage_id == 190209 or $stage_hook == 190209) $background_color = 'background-color:#8a5cdb;';
		if($stage_id == 190209 or $stage_hook == 190209) $color = '#111;';
	...
	$display = ($stage_id == 190209 or $stage_hook == 190209 or $stage_id == 190321 or $stage_hook == 190321) ? '' : 'display:none;' ;
	echo '<div class="scroll-wrap liminfo lim190209 lim190321 limuserplan" style="'.$display.'background-color:#222;color:#ccc;"><span style="color:#fff;font-size:1.2em;" glot-model="main_nav_userplan">参加者企画</span>'."\n";
	echo '<table class="series_nav"><tr>'."\n";
	$color = ($stage_id == 190209 or $stage_hook == 190209 or $stage_id == 190321 or $stage_hook == 190321) ? '#a773df' : '#aaa' ;
	echo '<td class="navmenulim" id="nv190209" style="font-weight:bold;font-size:1.1em;background-color:'.$color.';"><A style="color:#111111;" href="./190209" title="ピクミン2全ステージ各一本勝負"><span glot-model="main_nav_userplan1">ピクミン2全ステージ各一本勝負</span>（2019/02/09）</A></td>'."\n";
	echo '<td class="navmenulim" id="nv190321" style="font-weight:bold;font-size:1.1em;background-color:'.$color.';"><A style="color:#111111;" href="./190321" title="ピクミン2全ステージ各一本勝負"><span glot-model="main_nav_userplan1">ピクミン2全ステージ各一本勝負</span>（2019/03/21）</A></td>'."\n";
	echo '</tr><tr></table>'."\n";
	echo '</div>'."\n";
	...
	echo '<div class="scroll-wrap liminfo lim190209" style="'.$display.'background-color:#222;color:#ccc;">';
		topscore_board_tab("score", range(4001, 4030), $stage_id, 91, 190209);
	echo '</div>'."\n";
	...
	echo '<div class="scroll-wrap liminfo lim190321" style="'.$display.'background-color:#222;color:#ccc;">';
		topscore_board_tab("score", range(4031, 4060), $stage_id, 91, 190321);
	echo '</div>'."\n";
