...
// チーム名の定義 (0は使わない)
$team = array('', 'チーム青ピクミン', 'チーム赤ピクミン','チーム白ピクミン','チーム紫ピクミン','チーム羽ピクミン','チーム岩ピクミン','チームデメマダラ','チームヘビガラス','偉そうで偉くないチーム','偉そうで偉いチーム','飴坊主組','飴入道組','チームヒダマリノミ🍓','チームツラノカワ🍊','チームオフランス🍐','チームカワスベール🍌');
$team = array_translate($team, "team");

$teamc= array('', '19acff', 'ff3919', 'eeeeee', 'b419ff','ff63f2','e3e3e3','f3524c','8ba9ff','e0e0e0','010101','45aee6','e6d745','e6456c','e6b945','45e675','dce645');
...
// 開催回数からチーム番号を逆算する
$teamp = array();
$teamp['a'] = array(15 => 13, 16 => 15);
$teamp['b'] = array(15 => 14, 16 => 16);
