...
$limited211105 = range(3113, 3134);
$limited221008 = range(3135, 3146);
...
// リストアップ用に略称を定義
$limited_stage_title_fixed = array('個人戦','個人戦','個人戦','個人戦','個人戦','個人戦','チーム対抗戦','チーム対抗戦','チーム対抗戦','チーム対抗戦','チーム対抗戦','チーム対抗戦','エリア踏破戦','エリア踏破戦','エリア踏破戦','エリア踏破戦','エリア踏破戦','エリア踏破戦','エリア踏破戦');
...
$limited_stage_sub_fixed = array('スタンダード','スタンダード','スタンダード','スタンダード','スタンダード','スタンダード','スタンダード','スタンダード','短期決戦','ピンポイント','代表選抜制','ブラインド制','協力制','スタンダード','チーム対抗制','チーム対抗制','マイニング制','チーム対抗制');
$limited_stage_sub_fixed = array_translate($limited_stage_sub_fixed, "limited_stage_sub_fixed");

$limited_stage_win_fixed = array('参加者なし','ピクミンヤクザ (45,930 pts.)','バライト (68,580 pts.)','ピクミンヤクザ (15,075 pts.)','ピクミンヤクザ (80,223 pts.)','ピクミンヤクザ (17,765 pts.)',"チーム青ピクミン (98 - 97)","チーム白ピクミン (167 - 153)","チーム岩ピクミン (237 - 275)","チームヘビガラス (281 - 302)","偉そうで偉いチーム (231 - 242)","飴入道組 (314 - 327)","みんな (35 - 0)","iid01 (8 LPS)","チームツラノカワ🍊 (19 LPS)","チームオフランス🍐 (13 LPS)","チームクマキボリ🐻 (8,111 MPS)","？？？");
$limited_stage_mvp       = array('','','','','','','ピクミンヤクザ (33 RPS)','バライト (42 RPS)','flyinghawk (67 RPS)','ピクミンヤクザ (60 RPS)','じーた[次鋒] (56 RPS)','flyinghawk (76 RPS)','ごれい (16 LPS)','flyinghawk (80,910 pts.)','albut3 (680 RPS)','ごれい (422 RPS)','albut3 (305 RPS)','？？？');
$limited_stage_idea	 = array('','','','','','','','','','','','','','','コレクタールーム（250秒）[得票率23.4%：ピクミンヤクザ さん案]','神々のおもちゃ箱（線路は続くよどこまでも）[得票率22.3%：とりぽっぽ さん案]','炎と水の試練場（タイム200倍） [得票率19.2%: mercysnow さん案]','？？？');
$limited_stage_staff	 = array('','','','','','','','','','','','','','','','','albut3 さん（ステージ選定担当）','');

// チーム名の定義 (0は使わない)
$team = array('', 'チーム青ピクミン', 'チーム赤ピクミン','チーム白ピクミン','チーム紫ピクミン','チーム羽ピクミン','チーム岩ピクミン','チームデメマダラ','チームヘビガラス','偉そうで偉くないチーム','偉そうで偉いチーム','飴坊主組','飴入道組','チームヒダマリノミ🍓','チームツラノカワ🍊','チームオフランス🍐','チームカワスベール🍌','チームカフェオレ☕','チームクマキボリ🐻','チームオリマー🚀','チームチャーリー🐤');
$team = array_translate($team, "team");

$teamc= array('', '19acff', 'ff3919', 'eeeeee', 'b419ff','ff63f2','e3e3e3','f3524c','8ba9ff','e0e0e0','010101','45aee6','e6d745','e6456c','e6b945','45e675','dce645','457de6','e69345','e64575','455ae6');

// チーム固有絵文字の定義
$teame = array();
$teame['a'] = array(15 => "🍓", 16 => "🍐", 17 => "☕", 18=>"🚀");
$teame['b'] = array(15 => "🍊", 16 => "🍌", 17 => "🐻", 18=>"🐤");

// 開催回数からチーム番号を逆算する
$teamp = array();
$teamp['a'] = array(15 => 13, 16 => 15, 17 => 17, 18 => 19);
$teamp['b'] = array(15 => 14, 16 => 16, 17 => 18, 18 => 20);
...
$limited_time211105 = array('2021-11-05 22:00:00', '2021-11-07 21:59:59');
$limited_time221008 = array('2022-10-07 22:00:00', '2022-10-10 21:59:59');
